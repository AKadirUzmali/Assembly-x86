; ----------------------------------------------------------------------------------------------------------------
; PROGRAM : 16 Bit Toplama
; 16 bit tanımlı ASAYISI ve BSAYISI isimli değişkenleri toplayarak elde
; edilen sonucu TOPLAM isimli 32 bit'lik değişkene yerleştiren EXE program
; ----------------------------------------------------------------------------------------------------------------
        PAGE 60, 80
...
ASAYISI DW  1234H                   ; Giriş/Çıkış değerlerinin veri alani üzerinde ilk
...
; ----------------------------------------------------------------------------------------------------------------
        LEA SI, TOPLAM              ; SI TOPLAM değişkeninin başladığı adresi belirler
